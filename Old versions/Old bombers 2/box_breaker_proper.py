...
class agent:
    ...
    def next_move(self, game_state, player_state):
        ...
        for pos in box_locations: 
            if self.me_bfs_graph[pos[0]][pos[1]] < min_box_dist:
        ...
        # print(self.location)
        # print(box_locations)
        # print(self._count_box(self.location), goal_count)
        if ammo > 0:
            if self._count_box(self.location) == 3 or self._count_box(self.location) == goal_count:
                self.action = "p"
            else:
